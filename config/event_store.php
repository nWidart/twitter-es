...
//        ],
    ...
    */
    'projection_managers' => [
        'tweet_projection_manager' => [
            'store' => 'default',
            'projections' => [
                'timeline_projection' => [
                    'read_model' => \App\Twitter\Domain\Projection\TimelineReadModel::class,
                    'projection' => \App\Twitter\Domain\Projection\TimelineProjection::class,
                ],
            ],
        ],
